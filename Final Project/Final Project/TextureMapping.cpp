...
void initializeTextures(char* fileName)
{
...
void bindTextures() {
	...
	initializeTextures("main.ppm");

	glBindTexture(GL_TEXTURE_2D, texName[1]);
	initializeTextures("ground.ppm");

	glBindTexture(GL_TEXTURE_2D, texName[2]);
	initializeTextures("field.ppm");

	glBindTexture(GL_TEXTURE_2D, texName[3]);
	initializeTextures("lampTexture.ppm");
}
